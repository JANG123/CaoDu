...
- (void)drawView {
    ...
    _titleLabel.font = [UIFont adapterFontOfSize:17];
    ...
    _closeBtn.titleLabel.font = [UIFont adapterFontOfSize:15];
    ...
    _detailLabel.font = [UIFont adapterFontOfSize:16];
    ...
    _amountLabel.font = [UIFont adapterFontOfSize:33];
