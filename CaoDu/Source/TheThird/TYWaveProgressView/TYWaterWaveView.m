...
- (void)setUp
{
    waterWaveHeight = self.frame.size.height/2;
    waterWaveWidth  = self.frame.size.width;
    _firstWaveColor = [UIColor colorWithRed:118/255.0f green:207/255.0f blue:255/255.0f alpha:1];
    
    _secondWaveColor = [UIColor colorWithRed:32/255.0 green:178/255.0 blue:255/255.0 alpha:1];
