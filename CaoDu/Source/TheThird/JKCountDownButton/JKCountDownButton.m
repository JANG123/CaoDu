...
//    [[TelValiDateTolls shareGetTelValiDate]validateNumWithPhoneNum:@"18337109530" PassValue:^(NSString *string) {
//        if ([string isEqualToString:@"格式正确"]) {
//           [[TelValiDateTolls shareGetTelValiDate]telValiDataWithPhoneNum:@"18337109530" PassValue:^(NSString *string) {
//               
//           }];
//        }else{
//        
