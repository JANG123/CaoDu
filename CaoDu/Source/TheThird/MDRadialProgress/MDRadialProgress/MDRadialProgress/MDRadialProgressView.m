...
@property (assign, nonatomic) double internalPadding;
...
@property (assign, nonatomic) double progressCounterTemp;
...
- (void)setProgressCounter:(double)progressCounter
{
				   ...
				   inContext:(CGContextRef)context
{
    ...
    double startingSlice = self.startingSlice -1;
